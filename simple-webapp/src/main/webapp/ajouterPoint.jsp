...
<div class="container d-flex justify-content-center">
    <div class="form-container">
        ...
        <h2 class="text-center form-title mb-4">Ajouter un point de collecte</h2>
        ...
        <form action="addPoint" method="post">
            ...
            <div class="mb-3">
                <label class="form-label">Type Électrique</label>
                <input type="text" name="typeElectrique" class="form-control">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="contexte" class="form-control">
            </div>
        ...
        <div class="text-center mt-3">
            <a href="points" class="back-link text-dark">← Retour</a>
        </div>
